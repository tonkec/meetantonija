...
const projects = [
  {
    ...
    responsibilities: [
      ...
      },
      {
        ...
        description:
          'Contributed to the successful delivery of projects.',
      },
      {
  ...
  },
  {
    ...
    responsibilities: [
      {
        title: 'Led the migration of the existing codebase from Knockout.js to React',
        description:
        ...
        title: 'Collaborated with cross-functional teams to develop cutting-edge features and enhancements',
        description:
      ...
      {
        title: 'Contributed to the development of real-time interactive features using GraphQL',
        description:
      ...
      {
        title: 'Integrated external services such as Contentful, Wordpress, Keycloak, and Jenkins',
        description:
    ...
    responsibilities : [
      {
        ...
        description: "Mastered Angular within a month to architect a robust communication framework between the Angular-based user interface and the Raisenow API, similar to Stripe, ensuring seamless data flow, optimized performance, and efficient API interactions."
      },
      {
        title: "Acquiring Proficiency in Typescript and RxJS",
        description: "Acquired proficiency in Typescript and RxJS, vital for developing efficient and maintainable code, enabling seamless handling of asynchronous operations and data streams."
      },
      {
        title: "Spearheading Architecture",
        description: "Spearheaded the architecture for communication between the Angular UI and the Raisenow API, establishing clear patterns for data exchange, optimizing API requests, and handling responses effectively."
      },
      {
        title: "Ensuring Code Quality",
        description: "Ensured code quality and reliability through comprehensive testing using Jest, identifying and rectifying potential issues early in the development process."
      },
      {
        title: "Integrating Systems",
        description: "Successfully integrated the Angular UI with the Raisenow API, navigating its intricacies to ensure smooth data synchronization and accurate transaction handling."
      }
    ],
    ...
    responsibilities : [
      {
        ...
        description: "Designed and implemented the user interface of the mobile app using React Native, leveraging libraries such as react-native-elements and react-native to ensure a seamless and visually appealing experience for users."
      },
      {
        title: "Handling User Authentication and Authorization",
        description: "Handled user authentication and authorization, orchestrating Ajax calls to communicate with the backend API, and validating user credentials to ensure the security and privacy of our users."
      },
      {
        title: "Utilizing AsyncStorage for Data Management",
        description: "Utilized AsyncStorage to securely store and manage user tokens, ensuring the integrity of user data and facilitating smooth interactions for returning users."
      }
    ],    
    conclusion:
    ...
    responsibilities : [
      {
        ...
        description: "As the sole developer for Revuto, I played a pivotal role in the platform's evolution, employing technologies such as Axios, interceptors, and React Context to efficiently manage API requests and responses, ensuring data integrity and seamless user experiences."
      },
      {
        title: "API Integration and Optimization",
        description: "Successfully integrated APIs into the Revuto platform, optimizing data flow and communication. Leveraging interceptors, I handled authentication, error handling, and other cross-cutting concerns, enhancing the reliability and security of the application."
      },
    ],    
    conclusion:
    ...
    responsibilities :[
      {
        ...
        description: "Undertook a pivotal role in enhancing the functionality and user experience of Code Institute's Learning Management System (LMS) based on Django."
      },
      {
        title: "Integration of New Components",
        description: "Integrated various new components into the existing LMS, including quizzes, embedded repl.it, sidebars, course content, headers, and footers, transforming it into a seamless and efficient platform for learners."
      },
      {
        title: "Front-end Development",
        description: "Coded the interface of every course module, demonstrating prowess in front-end development and leveraging CSS and SCSS skills to create visually appealing and intuitive user interfaces."
      },
      {
        title: "Codebase Optimization",
        description: "Optimized the existing LMS codebase to enhance performance, resulting in a cleaner and swifter platform that improved user experience and streamlined backend processes."
      }
    ],    
    conclusion:
    ...
    responsibilities : [
      {
        ...
        description: "Assumed the role of a static website developer at Supersuperstudio, responsible for creating impactful online interfaces that aligned with provided design concepts."
      },
      {
        title: "Translation of Design Visuals",
        description: "Translated static design visuals into fully functional user interfaces using HTML, SCSS, and JavaScript."
      },
      {
        title: "Creation of Interactive Web Pages",
        description: "Meticulously transformed static visuals into interactive and engaging web pages, leveraging HTML as the structural backbone and SCSS to style elements to mirror the design's aesthetics."
      },
      {
        title: "Implementation of JavaScript",
        description: "Incorporated JavaScript to enhance interactivity and functionality, creating dynamic elements, implementing animations, and facilitating user engagement."
      }
    ],    
    conclusion:
    ...
    responsibilities : [
      {
        ...
        description: "Implemented D3/DC charts into the explorer section of the PIMSF app, making them draggable and resizable using the react-grid-layout npm package."
      },
      {
        title: "Creation of Draggable and Resizable Grid Layout",
        description: "Created a plain draggable and resizable 8-column grid layout and added graphs to columns, ensuring that the graphs followed the height and width of the parent column."
      },
      {
        title: "Ensuring Responsiveness of Grid Layout",
        description: "Ensured responsiveness of the grid layout by utilizing built-in properties and functions of react-grid-layout to create a grid based on breakpoints."
      },
      {
        title: "Development of Changelog History Tree",
        description: "Developed a changelog history tree to display each version of a pipeline using Mermaid.js, where each new version is treated as a child and each old version as a parent."
      },
      {
        title: "Utilization of Axios for API Data Fetching",
        description: "Utilized Axios to fetch data points from the API and implemented functionality to delete or approve pipelines, dynamically changing their color based on approval status."
      }
    ],    
    conclusion:
    ...
    responsibilities : [
      {
        ...
        description: "Implemented pixel-perfect layout based on Zeplin designs for the homepage and landing page of Tint's product."
      },
      {
        title: "Coding Global Navigation and Footer Elements",
        description: "Coded global navigation and footer elements to ensure consistency and functionality across the website."
      },
      {
        title: "Development of Animations and Transitions",
        description: "Developed animations and transitions from scratch using custom CSS and jQuery/JavaScript."
      },
      {
        title: "Participation in Design Sessions",
        description: "Participated in design sessions, collaborating with the team to bring creative ideas to life and ensure a visually appealing user experience."
      }
    ],    
    conclusion:
   ...
   responsibilities : [
      {
        ...
        description: "Implemented dynamic and responsive user interfaces using React, leveraging its component-based architecture to develop modular and reusable UI components."
      },
      {
        title: "Utilization of TypeScript for Enhanced Development",
        description: "Utilized TypeScript to bring type safety and enhanced tooling to the development process, identifying and preventing potential errors early in the development lifecycle."
      },
      {
        title: "Integration of React Query for Efficient Data Fetching",
        description: "Integrated React Query into the Funder Pro platform to facilitate efficient data fetching and state management, optimizing network requests and improving platform performance."
      },
      {
        title: "Driving Innovation and Delivering Best-in-Class Trading Experience",
        description: "Contributed to driving innovation and delivering a best-in-class trading experience to users by harnessing the power of React, TypeScript, and React Query."
      }
    ],    
    conclusion:
