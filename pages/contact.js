  ...
  const onSubmitForm = (e) => {
    ...
    emailjs
      ...
      .then(
        (response) => {
          setMessage(
            "Thank you for your message! I will get back to you soon :D"
          );
        },
        (err) => {
          console.log(err);
    ...
    <Layout>
      ...
      <section className="bg-gray py-20 text-center">
        ...
        <form
          ...
          className="w-8/12 md:w-6/12 mx-auto"
        >
          <input
            type="text"
            required
        ...
        {messageText !== null && (
          <div
            ref={messageRef}
            className="fixed bottom-0 left-0 right-0 bg-primary text-white py-6 text-center"
          >
            {messageText}
          </div>
        )}
